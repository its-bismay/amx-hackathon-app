...
SCHEMA_PATH = Path('C:/Users/91891/OneDrive/Desktop/amx/secure-banking-fabric/prisma/bank.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\91891\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    beneficiary: 'actions.BeneficiaryActions[models.Beneficiary]'
    transaction: 'actions.TransactionActions[models.Transaction]'
    ledger: 'actions.LedgerActions[models.Ledger]'
    ...
    def __init__(
        ...
        *,
        ...
        self.beneficiary = actions.BeneficiaryActions[models.Beneficiary](self, models.Beneficiary)
        self.transaction = actions.TransactionActions[models.Transaction](self, models.Transaction)
        self.ledger = actions.LedgerActions[models.Ledger](self, models.Ledger)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': None, 'fromEnvVar': 'BANK_DATABASE_URL'}).resolve(),
            'source_file_path': 'C:/Users/91891/OneDrive/Desktop/amx/secure-banking-fabric/prisma/bank.prisma',
        }
...
class Batch:
    ...
    beneficiary: 'BeneficiaryBatchActions'
    transaction: 'TransactionBatchActions'
    ledger: 'LedgerBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.beneficiary = BeneficiaryBatchActions(self)
        self.transaction = TransactionBatchActions(self)
        self.ledger = LedgerBatchActions(self)
